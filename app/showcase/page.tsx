...
export default async function ShowcasePage() {
  ...
  return <main className="showcase-page">
    ...
    <section className="showcase-hero"><p>MON CHIC PARIS</p><h1>Ausgewählte Vintage- und Designerstücke</h1><span>Ein digitales Schaufenster auf Basis derselben Artikel-DNA.</span></section>
    ...
    })}</section> : <section className="showcase-empty"><h2>Das digitale Schaufenster wird kuratiert.</h2><p>Artikel mit Status „Aktiv“ erscheinen hier automatisch.</p></section>}
  </main>;
}
