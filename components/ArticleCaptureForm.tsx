...
export default function ArticleEditor({ id }: { id: string }) {
  ...
  async function analyzeAllPhotos() {
    ...
    try {
      ...
      setAiDraft({
        brand: result.brand, category: result.category, subcategory: result.subcategory,
  ...
  return <div className="capture-form">
    ...
    <section className="capture-card">
      <div className="capture-heading"><div><span className="step-badge plain">✦</span><h2>KI-Analyse</h2></div><button type="button" className="ai-analysis-button" onClick={analyzeAllPhotos} disabled={analyzing || !item.product_images?.length || Boolean(aiBudget?.blocked)}>{analyzing ? 'KI analysiert …' : aiBudget?.blocked ? 'KI-Budget erreicht' : '✦ Alle Fotos analysieren'}</button></div>
    ...
    <section className="capture-card" style={{maxWidth: 340}}>
      <div className="capture-heading"><div><span className="step-badge plain">↺</span><h2>Referenzfoto</h2></div></div>
    ...
    <section className="capture-card">
      <div className="capture-heading"><div><span className="step-badge">3.</span><h2>Preise</h2></div></div>
      <div className="form-grid">
    ...
    <section className="capture-card">
      <div className="capture-heading"><div><span className="step-badge">4.</span><h2>Referenzen & Bestellung</h2></div></div>
      <div className="form-grid">
    ...
    <section className="capture-card">
      <div className="capture-heading"><div><span className="step-badge">5.</span><h2>Lager & Inventur</h2></div></div>
      <div className="form-grid">
